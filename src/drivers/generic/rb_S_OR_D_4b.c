...
void _cdecl rb_S_OR_D_4b(ROP_PB *rpb);

void _cdecl
rb_S_OR_D_4b(ROP_PB *rpb)
{
			...
			if (swords == dwords)
			{
				...
				else
				{
					for (; height > 0; height--)
					{
						...
						*d-- |= ((p1 >> rshift) | (*s-- << shift)) & endmask;
						*d-- |= ((p2 >> rshift) | (*s-- << shift)) & endmask;
						*d-- |= ((p3 >> rshift) | (*s-- << shift)) & endmask;
						d -= dbpl, s -= sbpl;
					}
				}
			}
				...
				else
				{
					for (; height > 0; height--)
					{
						...
						*d-- |= ((p0 >> shift) | (*s << rshift)) & begmask;
						p0 = *s--;
						*d-- |= ((p1 >> shift) | (*s << rshift)) & begmask;
						p1 = *s--;
						*d-- |= ((p2 >> shift) | (*s << rshift)) & begmask;
						p2 = *s--;
						*d-- |= ((p3 >> shift) | (*s << rshift)) & begmask;
						p3 = *s--;
			...
			else /* more src words */
			{
				...
				else
				{
					for (; height > 0; height--)
					{
						...
						*d-- |= ((p1 >> shift) | (*s-- << rshift)) & endmask;
						*d-- |= ((p2 >> shift) | (*s-- << rshift)) & endmask;
						*d-- |= ((p3 >> shift) | (*s-- << rshift)) & endmask;
						d -= dbpl, s -= sbpl;
					}
				}
			}
